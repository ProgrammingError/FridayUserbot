...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_file(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your tatti 🇮🇳", data="deploy")],
                [Button.url("Help Me ❓", "t.me/tattiot")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="You Can Deploy tatti In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            buttons=[
                [Button.url("Deploy Tutorial 📺", "https://youtu.be/xfHcm_e92eQ")],
                [Button.url("Need Help ❓", "t.me/tattiSupportOfficial")],
            ],
        )
