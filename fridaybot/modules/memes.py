...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit(
            "Hello , User I Am Using [ʄʀɨɖǟʏUserbot](https://github.com/Starkgang/ʄʀɨɖǟʏUserbot) ! Worth A Try 😌"
        )
